...
ALTER TABLE servers ALTER COLUMN id RESTART WITH 1;
ALTER TABLE alert_rule ALTER COLUMN id RESTART WITH 1;
ALTER TABLE alert_event ALTER COLUMN id RESTART WITH 1;
ALTER TABLE server_metrics ALTER COLUMN id RESTART WITH 1;
